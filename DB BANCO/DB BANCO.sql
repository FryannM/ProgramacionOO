...
RNC VARCHAR2(30)  UNIQUE NOT NULL,
...
BALANCE_DB NUMBER(20,2) NOT NULL,
BALANCE_CR NUMBER(20,2) NOT NULL,
...
ID_TIPO_DOC_BANCARIO NUMBER(20),// --UN CLIENTE TIENE 0 O N (MUCHOS) TIPO DE DOCUMENTO (TARJETA DE CREDITO, TARJETA DE DEBITO, LIBRETA)
NUM_DOCUMENTO NUMBER UNIQUE NOT NULL,
NOMBRE VARCHAR(50) NOT NULL,
ESTADO VARCHAR(1) NOT NULL,
...
ALTER TABLE BC_CLIENTES ADD CONSTRAINT FK_TIPO_DOC_TO_CLIENTE FOREIGN KEY (ID_TIPO_DOC_BANCARIO) REFERENCES BC_TIPO_DOC_BANCARIOS (ID_TIPO_DOC_BANCARIO);
---//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
